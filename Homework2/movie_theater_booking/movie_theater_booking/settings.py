...
SECRET_KEY = 'django-insecure-d+oh7l#fsc94ck+hoe52=2ic*=k!e6w_&yfg!w=ep@*j2y@8#v'
...
CSRF_TRUSTED_ORIGINS = [
    'https://app-cs4300craiglillemon-5.devedu.io',  # Add your domain here
    # You can add more origins if needed, for example:
    # 'http://localhost:3000',  # If you are testing on localhost
]
